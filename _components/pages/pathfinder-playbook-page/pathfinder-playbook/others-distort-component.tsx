  ...
  return (
    <div className={classNames("flex flex-col gap-5", cssClasses)}>
      ...
      <ul className="list-disc pl-5 flex flex-col gap-1 desktop:hidden">
        <li>
          <strong>Without Structure</strong>, optionality becomes reactivity.
        </li>
        <li>
          <strong>Without Mentor perspective</strong>, blind spots compound.
        </li>
        <li>
          <strong>Without Community</strong>, advisors carry disproportionate
          influence.
        </li>
        <li>
          <strong>Without Financial discipline</strong>, capital fragments.
        </li>
        <li>
          <strong>Without structured guidance</strong>, risk appetite changes
          silently.
        </li>
      </ul>
