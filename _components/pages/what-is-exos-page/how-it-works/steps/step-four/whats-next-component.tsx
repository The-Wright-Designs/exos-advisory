...
export default function WhatsNextComponent() {
  return (
    <div className="grid -mx-7 items-center gap-10 bg-charcoal px-10 py-15 min-[1000px]:mx-0 min-[1000px]:rounded-md desktop:bg-transparent desktop:border-y-[3px] border-citrine desktop:py-10 desktop:rounded-none desktop:col-span-2 desktop:grid-cols-[560px_1fr] desktop:px-0 desktop:gap-y-7">
