...
export default function HeroComponent() {
  return (
    <div className="relative w-full pb-[60px] max-w-[1280px] mx-auto">
      <div className="relative w-full pb-[90px] tablet:pb-[60px] desktop:pb-0 desktop:grid grid-cols-[452px_1fr]">
        ...
        <div className="absolute bottom-2 grid place-items-center w-full px-5 desktop:relative desktop:bottom-0 desktop:bg-citrine desktop:place-items-start desktop:p-15 overflow-hidden">
          ...
          <div className="bg-citrine max-w-[310px] h-[260px] rounded-[6px] drop-shadow-md p-5 grid place-items-center tablet:max-w-[620px] tablet:h-auto tablet:p-10 desktop:drop-shadow-none desktop:p-0 desktop:block desktop:max-w-max desktop:bg-transparent desktop:z-10">
            <p className="text-center flex flex-col gap-2 desktop:text-left desktop:gap-5">
              ...
              <span className="text-white text-[40px] font-bold desktop:font-medium desktop:text-[64px] font-nudista-hero desktop:pt-10 desktop:border-t-[3px] border-charcoal desktop:min-w-[708px]">
                What comes next?
              </span>
            </p>
          </div>
